function parameter = setWamamParameter(Coeffs,labels)
%Set parameter for function extractMraFeatures based on wavelet+amam
...
parameter.ns = 16*ones(1,nComponents);
