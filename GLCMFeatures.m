...
% 1, pp. 45-62, 2002
% 4. Banik S, Rangayyan RM, Desautels JE. Measures of angular spread and entropy for the detection of
% architectural distortion in prior mammograms. International Journal of Computer assisted Radiology
% and Surgery. 2013; 8(1):121±134. https://doi.org/10.1007/s11548-012-0681-x PMID: 22460365
% 5. Yang X, Tridandapani S, Beitler JJ, Yu DS, Yoshida EJ, Curran WJ, et al. Ultrasound GLCM texture analysis
% of radiation-induced parotid-gland injury in head-and-neck cancer radiotherapy: An in vivo study of
% late toxicity. Med Phys. 2012; 39(9):5732±5739. https://doi.org/10.1118/1.4747526 PMID: 22957638
...
out.rEntropy                            = zeros(1,nglcm); % Renyi entropy [4], q=8
out.tEntropy                            = zeros(1,nglcm); % Tsallis entropy [5], r=2
...
for k = 1:nglcm 
    ...
    out.rEntropy(k)             = -log(nansum(currentGLCM(sub).^8))/7; % q=8
    out.tEntropy(k)             = -nansum(currentGLCM(sub).^2); % r=2                           
